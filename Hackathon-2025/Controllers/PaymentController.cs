    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Webhook()
        {
            try
            {
                ...
                // ... rest unchanged (your idempotency + updates)
                // (Your existing transactional fence and updates go here exactly as you had them.)
                // Returning early to keep this snippet focused on Options usage:
                return Ok();
            }
